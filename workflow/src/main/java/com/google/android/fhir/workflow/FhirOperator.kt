...
internal constructor(
  ...
  private val measureProcessor:FhirEngineR4MeasureProcessor = FhirEngineR4MeasureProcessor(repository, measureEvaluationOptions)
  ...
  fun evaluateMeasure(
    ...
    val evalType = MeasureEvalType.fromCode(reportType)
      .orElse(if (!subjectId.isNullOrEmpty()) MeasureEvalType.SUBJECT else MeasureEvalType.POPULATION) as MeasureEvalType
